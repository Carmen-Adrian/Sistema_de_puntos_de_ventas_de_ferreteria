...
public class fusuario {
    ...
    public boolean insertar(vusuario dts) {
        cn = ConexionConBaseDatos.getConexion();
        sSQL = "insert into usuario (id,usuario,pasword,tipo,nombres,apellidos,dni,telefono)" + "values (?,?,?,?,?,?,?,?)";
        //sSQL2 = "insert into usuario (id,usuario,pasword,tipo,nombres,apellidos,dni,telefono)" + "values (?,?,?,?,?,?,?,?)";
        try {
